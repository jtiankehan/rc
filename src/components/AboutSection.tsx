...
export default function AboutSection() {
  return (
    <section id="about" style={{ background: '#f5f8f6', padding: '100px 0', position: 'relative', overflow: 'hidden' }}>
      {/* subtle top divider */}
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 48px' }} className="about-container">
        <div id="about-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 0.78fr', gap: '80px', alignItems: 'center' }}>
          ...
          <div className="about-text">
            ...
            {/* stats */}
            <div id="about-stats" style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', borderTop:'1px solid rgba(0,0,0,0.07)', paddingTop:28 }}>
          ...
          <div id="about-video-wrap" className="about-video" style={{
            position: 'relative',
      ...
      <style>{`
        .about-text {
          animation: sectionFadeUp 0.8s ease both;
          animation-play-state: paused;
        }
        .about-video {
          animation: sectionFadeRight 0.9s 0.15s ease both;
          animation-play-state: paused;
        }
        #about.in-view .about-text { animation-play-state: running; }
        #about.in-view .about-video { animation-play-state: running; }
        ...
        @media (max-width: 768px) {
          ...
          #about-video-wrap { height: 260px !important; }
